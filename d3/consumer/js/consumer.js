(function(E, X) {
    typeof module === "object" && module.exports ? module.exports = E.document ? X(E) : X : E.Consumer = X(E)
})(typeof window !== "undefined" ? window : this, function(E) {
    function X(a, b) {
        var c = "Consumer error #" + a + ":" + a;
        if (b) throw Error(c);
    ...
    if (E.jQuery) E.jQuery.fn.consumer = function() {
        var a = [].slice.call(arguments);
        if (this[0]) return a[0] ? (new(B[xa(a[0]) ? a.shift() : "Chart"])(this[0], a[0], a[1]), this) : S[K(this[0], "data-consumer-chart")]
    };
    ...
    O.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                s = s.join(",");
                i[s] ? n = i[s].attr("id") : (g.id = n = "consumer-" + zb++, i[s] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], o(j, function(a) {
                ...
                if (h.namespaceURI === Fa || d.forExport) {
                    try {
                        l = this.fakeTS && function(a) {
                            o(h.querySelectorAll(".consumer-text-shadow"), function(b) {
                                b.style.display =
                                    a
                            })
    ...
    Ca.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            this.createElement("desc").add().element.appendChild(y.createTextNode("Created with Consumer"));
        ...
        getOffset: function() {
            ...
            if (!a.axisGroup) a.gridGroup =
                c.g("grid").attr({
                    ...
                    zIndex: s.zIndex || 7
                }).addClass("consumer-" + a.coll.toLowerCase() + "-labels").add(ba);
            if (k || a.isLinked) {
                if (o(e, function(b) {
            ...
            if (r && r.text && r.enabled !== !1) {
                ...
                }).addClass("consumer-" + this.coll.toLowerCase() + "-title").css(r.style).add(a.axisGroup), a.axisTitle.isNew = !0;
    ...
    Xa.prototype = {
        ...
        onDocumentMouseMove: function(a) {
            ...
            c && !this.inClass(a.target, "consumer-tracker") && !b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) && this.reset()
        },
        ...
        onContainerMouseMove: function(a) {
            ...
            (this.inClass(a.target, "consumer-tracker") || b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop)) && !b.openMenu && this.runPointActions(a)
        },
        inClass: function(a, b) {
            for (var c; a;) {
                if (c = K(a, "class")) {
                    if (c.indexOf(b) !== -1) return !0;
                    if (c.indexOf("consumer-container") !== -1) return !1
                }
                a = a.parentNode
            }
        },
        onTrackerMouseOut: function(a) {
            ...
            if (b && a && !b.options.stickyTracking &&
                !this.inClass(a, "consumer-tooltip") && !this.inClass(a, "consumer-series-" + b.index)) b.onMouseOut()
        },
        onContainerClick: function(a) {
            var b = this.chart,
                ...
                e = b.plotTop,
                a = this.normalize(a);
            b.cancelClick || (c && this.inClass(a.target, "consumer-tracker") ? (H(c.series, "click", u(a, {
                point: c
    ...
    u(B.Pointer.prototype, {
        ...
        pinch: function(a) {
            var b = this,
                ...
                i = b.selectionMarker,
                k = {},
                j = f === 1 && (b.inClass(a.target, "consumer-tracker") && c.runTrackerClick || b.runChartClick),
                l = {};
    ...
    hb.prototype = {
        ...
        getContainer: function() {
            ...
            a || X(13, !0);
            d = C(K(a, "data-consumer-chart"));
            !isNaN(d) && S[d] && S[d].hasRendered && S[d].destroy();
            K(a, "data-consumer-chart", this.index);
            a.innerHTML = "";
            ...
            this.container =
                a = Z(La, {
                    className: "consumer-container" + (c.className ? " " + c.className : ""),
                    id: f
                }, u({
                    position: "relative",
                    overflow: "hidden",
        ...
        drawChartBox: function() {
            ...
            if (i || k)
                if (e) e.animate(e.crisp({
                    ...
                    this.chartBackground = b.rect(n / 2, n / 2, c - n, d - n, a.borderRadius, i).attr(e).addClass("consumer-background").add().shadow(a.shadow)
                }
        ...
        destroy: function() {
            ...
            S[a.index] = z;
            eb--;
            a.renderTo.removeAttribute("data-consumer-chart");
            V(a);
    ...
    Q.prototype = {
        ...
        plotGroup: function(a, b, c, d, e) {
            ...
            g && (this[a] = f = this.chart.renderer.g(b).attr({
                zIndex: d || 0.1
            }).add(e), f.addClass("consumer-series-" + this.index));
            f.attr({
                visibility: c
    ...
    da = B.TrackerMixin = {
        drawTrackerPoint: function() {
            ...
            if (!a._hasTracking) o(a.trackerGroups, function(b) {
                if (a[b] && (a[b].addClass("consumer-tracker").on("mouseover", f).on("mouseout", function(a) {
        ...
        drawTrackerGraph: function() {
            ...
            k ? k.attr({
                ...
                a.addClass("consumer-tracker").on("mouseover", m).on("mouseout", function(a) {
